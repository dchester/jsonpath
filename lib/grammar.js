var grammar = {
	...
	[ 'INTEGER',           'yy.ast.set({ expression: { type: "numeric_literal", value: $1 } })' ],
	[ 'END',               'yy.ast.set({ expression: { type: "eol" } })' ] ],
	...
	[ 'SUBSCRIPT_EXPRESSION_LIST , SUBSCRIPT_EXPRESSION', 'yy.ast.node().expression.value.push( $3 )' ] ],
      ...
      SUBSCRIPT_EXPRESSION: [
	[ 'INTEGER',           '$$ = { expression: { type: "numeric_literal", value: $1 } }; yy.ast.set($$)' ],
